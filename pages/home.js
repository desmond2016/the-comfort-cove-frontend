    ...
    export function renderHomePage(container, navigateCallback) {
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="category-card bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-lg cursor-pointer" data-category="claude-chat">
              ...
              <div class="p-6">
                ...
                <p class="text-gray-600 mb-4">使用 AI 进行个性化心理问题咨询和解答，随时获得支持。</p>
                <div class="flex justify-between items-center">
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <p class="text-gray-600">与 AI 进行自然对话，得到个性化的心理咨询和建议，解答成长中的困惑。</p>
            </div>
      ...
      renderChatbot(chatbotColumn); // 默认标题 "AI 心理小助手"
      ...
      introColumn.innerHTML = `
        ...
        <p class="text-gray-700 mb-4">
          我们的 AI 心理助手基于强大的AI大模型，可以帮助你解答心理成长中遇到的各种疑问。它提供温暖、科学的心理支持和建议，随时随地为你服务。
        </p>
        <!-- <p class="text-gray-700 mb-6">
          提问前需要先设置你的 Claude API 密钥。
        </p> -->
        <p class="text-gray-700 mb-6">
          不管是情绪困扰、人际关系问题，还是学业压力、自我认知，都可以向 AI 助手提问。
        </p>
        <div class="space-y-3">
